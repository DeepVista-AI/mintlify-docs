...
<Card title="Connecting Forms to Discord via Webhooks" icon="discord" href="/tutorials/managing-workflows">
  Covers creating a Discord webhook in more detail. Step 3 below repeats the key parts inline for convenience.
</Card>
