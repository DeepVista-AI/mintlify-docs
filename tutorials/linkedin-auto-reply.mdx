...
<Steps>
  <Step title="Type the following prompt in https://app.deepvista.ai">
    ```text wrap
    Set up a workflow based on https://raw.githubusercontent.com/DeepVista-AI/ai-native-skills/refs/heads/main/skills/workflow-unipile-linkedin-message-response.md
    ```
  </Step>
