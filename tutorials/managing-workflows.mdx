---
title: "Getting Discord Notification on Triggering Tasks. "
description: "Trigger Discord Notification on key updates on tasks and outputs."
---

## Sample Workflow

You can now connecting Forms to Discord via Webhooks. By the end, every form signup will trigger an automatic Discord alert, with DeepVista handling the two-way webhook wiring so you don't write any code.
...
<Steps>
  ...
  <Step title="Train the Workflow with a UI Screenshot">
    ...
    > _"My input form looks like this, please update the workflow."_
