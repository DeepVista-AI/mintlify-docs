---
title: "Get Discord Notifications on Task Updates"
description: "Trigger a Discord notification on key task and output updates."
---

## Overview

You can now connect Forms to Discord via Webhooks. By the end, every form signup will trigger an automatic Discord alert, with DeepVista handling the two-way webhook wiring so you don't write any code.
