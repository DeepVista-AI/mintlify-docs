...
<Note>
  This is an alternative to [Connect Your Own Machine](/tutorials/server/local), not a follow-on step — pick whichever fits your workload, you don't need to do both.
</Note>
...
<Steps>
  ...
  <Step title="Authorize with Claude Code">
    Once your dedicated private server is active, authenticate it with Claude the same way you would any connected machine — see the linked tutorial below for the full walkthrough.
  </Step>
</Steps>
